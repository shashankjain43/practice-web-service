...
public class RequestViewSearchValidator implements
         ConstraintValidator<RequestViewSearchRequestValidation, GetRequestViewSearchRequest> {

   @Override
   public void initialize(RequestViewSearchRequestValidation constraintAnnotation) {
   }

   @Override
   public boolean isValid(GetRequestViewSearchRequest request, ConstraintValidatorContext context) {
