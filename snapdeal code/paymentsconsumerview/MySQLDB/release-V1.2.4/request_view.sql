...
use request_view;
  ...
  `freecharge_txn_id` varchar(45) NOT NULL,
  ...
  `src_party_id` varchar(255) NOT NULL,
  `dest_party_id` varchar(255)  NOT NULL,
  `src_email_id` varchar(255)  DEFAULT NULL,
  `src_mobile_number` varchar(10)  DEFAULT NULL,
  `dest_email_id` varchar(255)  DEFAULT NULL,
