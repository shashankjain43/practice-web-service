...
gulp.task('addTemplates', function () {
  return gulp.src(paths.src + '/samplefiles/**')
    .pipe(gulp.dest(paths.dist + '/samplefiles/'));
});


gulp.task('addSampleFiles', function () {
  return gulp.src(paths.src + '/templates/*')
    .pipe(gulp.dest(paths.dist + '/templates/'));
});

gulp.task('buildapp', ['html', 'addTemplates','addSampleFiles', 'images', 'fonts', 'translations', 'misc', 'data', 'examplejs']);
