...
(function($, window, document) {
	...
	$.fn.dataTable = function( oInit )
	{
		...
		function classSettings ()
		{
			...
			/*this.aLengthMenu = [ 10, 25, 50, 100 ]; --changing default menu ~amit. */
			this.aLengthMenu = [ [ -1, 10, 25, 50, 100 ], [ 'All', 10, 25, 50, 100 ] ];
			...
			this._iDisplayLength = 100;  // changing default to 100 ~amit
