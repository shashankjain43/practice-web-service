...
@Service("fcUserIdEmailIdSet")
public class FCUserIdEmailIdSet extends IMSAerospikeBaseClass<Integer, String> {

   public FCUserIdEmailIdSet() {
      super(Set.FCUSERID_EMAIL_SET);
   }
