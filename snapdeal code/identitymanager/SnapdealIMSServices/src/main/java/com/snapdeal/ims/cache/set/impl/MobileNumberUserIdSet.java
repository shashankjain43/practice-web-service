...
@Service("mobileNumberUserIdSet")
public class MobileNumberUserIdSet extends IMSAerospikeBaseClass<String, String> {

   
   public MobileNumberUserIdSet() {
      super(Set.USER_MOBILE_SET);
   }
