...
@Component("VIPMSInventoryStatusQListener")
public class VIPMSInventoryStatusQListener implements MessageListener{

    private static final Logger log = LoggerFactory.getLogger("vipmsInventoryQListener.logger");
    ...
    public void onMessage(Message message) {
        ...
        try{
            ...
            log.info("Listened a message of size from the VIPMS inventory status Queue: " + messageSize);
            ...
            log.error(ExceptionUtils.getFullStackTrace(jex));
        }
