...
(function($) {
  ...
  $.material =  {
    "options": {
      ...
      "checkboxElements": ".checkbox > label > input[type=checkbox],.checkbox > label > input[type=radio]",
    ...
    "input": function(selector) {
      ...
      $(document)
      .on("change", ".checkbox input[type=checkbox],.checkbox input[type=radio]", function() { $(this).blur(); })
