...
public class ProducerRankQThread implements Runnable {
    ...
    private Logger LOG = LoggerFactory.getLogger(ProducerRankQThread.class);

    public ProducerRankQThread(SUPCSellerUpdateEventsSRO supcSellerUpdateEventsSRO) {
    ...
    public static void setSession(Session session) {
        ProducerRankQThread.session = session;
    }
    ...
    public static void setMessageProducer(MessageProducer messageProducer) {
        ProducerRankQThread.messageProducer = messageProducer;
    }
