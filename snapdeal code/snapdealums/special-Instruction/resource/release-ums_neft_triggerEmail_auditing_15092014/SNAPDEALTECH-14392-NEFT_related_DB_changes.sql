CREATE TABLE `ums`.`user_neft_details` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `unique_user_neft_dtls` (`email`,`ifsc_code`,`branch`,`bank_name`,`account_no`,`accHolderName`),
...
alter table `ums`.`sms_template` drop foreign key fk_sms_channel_id;
...
INSERT INTO `ums`.`email_template` (`name`,`subject_template`,`body_template`,`from`,`to`,`cc`,`bcc`,`reply_to`,`email_channel_id`,`email_type`,`enabled`,`created`) VALUES ('userNEFTDetailsUpdated','Your NEFT details have been udpated!','','Snapdeal <noreply@snapdeals.co.in>','','','','Snapdeal <noreply@snapdeals.co.in>',4,null,1,'2014-08-15 19:07:30');
