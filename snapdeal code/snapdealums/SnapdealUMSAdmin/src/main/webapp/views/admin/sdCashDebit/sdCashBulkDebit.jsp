...
<title>Upload SDCash Debit Excel Sheet</title>
</head>
<body>
				...
				<div class="gray-cont">
					<div class="wrapper2">
						<div class="head-lable">
							Upload <font color="red">SDCash Bulk Debit</font> <font color="blue">Excel</font>
							Sheet
						</div>
						<div>Please NOTE:</div>
						<br>
						...
						<div>2. First column corresponds to "emailID". Second column
							with SD cash. Third column to order ID.</div>
						<div>3. Processing the file could take a few minutes. Please
							do not resubmit the file again, or else, debit would happen
							TWICE!</div>
...
function myFunction() {
    document.getElementById("process").style.color = "grey";
					...
					<form:form action="processSDCashBulkDebitUpload" method="post"
				...
				<c:if
					...
					<h2>
						...
						<font color="black">Processing failed. Any executed
							transactions were rolled back. SD cash has not been debited to
							any user.</font>
					</h2>
				</c:if>
