...
<tiles:insertTemplate template="/views/layout/adminBasev3.jsp">
	...
	<tiles:putAttribute name="title"
		value="Order Management Vendor Dashboard - Update Successful" />
        	...
        	if("${suborders}" != ''){
        	 ...
        	 function searchVendor(){
               ...
               $('#shippingDetail').hide();
                 ...
                 var ajaxUrl = "/xhr/get/suborderInfo/uas" +"/"+ startDate +"/"+endDate+"/"+$('input[@name="radio_vouchers"]:checked').val();
        	 ...
        	 $('#save').click(function(){
        		 ...
        		 if( !$("input[@name='vendor']:checked").val() || suborderCode == "" || vendorCode == ""){
        			 ...
        			 var ajaxUrl = "/xhr/get/changevendor/ups/"+suborderCode+"/"+vendorCode;
...
//        	$("#lightboxVendor").fadeIn(300);
        ...
        function cancelVendor(subOrderCode,orderCode) {
        	$('#ajax-loader-icon').show();
        	var ajaxUrl = "/xhr/cancelvendor/ups/"+subOrderCode;
        	var subOrderData = {"suborderCode" : subOrderCode, "orderCode" : orderCode};
			...
			$.ajax({
				...
				success: function(data) {
					...
					if(data.length == 0){
						vhtml = ""; 
						alert("No Data found .Kindly reject this suborder");
					}else{
						alert(data.sr.m); 
					}
					searchVendor();							
	...
	<tiles:putAttribute name="body">
		<div id="internal-content">
			<div class="content-bdr">
				...
				<div id="comment"></div>
				<div class="head-lable">Update Successful</div>
				...
				<div class="cod-dash-menu">
					<ul style="float: none;">
						...
						<%-- <li><a href="${path.http}/admin/vrp/pendingFulfillment">Pending
						 ...
						 --%>
						<li><a href="${path.http}/admin/vrp/updateSuccessful"
							class="active">Update as Successful</a>
						</li>
				...
				<div class="cod-outer">
					...
					<div>
						<table width="100%" cellspacing="0" cellpadding="0">
							<tbody>
								<tr>
									<td colspan="4"><Strong>Show</Strong></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td width="10%" style="padding: 15px 15px 15px 49px;">End Date
									</td>
									<td><input id="endDate"
										class="input-fld-small-calendar hasDatepicker" type="text">
									</td>
						...
						<div id="back" style="padding: 5px 0; display: none;"
							class="backtotop">
							<a href="${path.http}/admin/vrp/updateSuccessful" class="active">New
								Search</a>
						</div>
