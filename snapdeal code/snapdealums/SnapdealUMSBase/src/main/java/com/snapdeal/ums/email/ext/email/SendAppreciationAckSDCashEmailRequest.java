...
public class SendAppreciationAckSDCashEmailRequest
    extends ServiceRequest
{
	 ...
	 * 
	 */
	private static final long serialVersionUID = -5171206216866703321L;
	@Tag(3)
    ...
    public SendAppreciationAckSDCashEmailRequest() {
    }

    public SendAppreciationAckSDCashEmailRequest(UserSRO user, Integer sdCashValue, boolean newUser, String conirmationLink, String contextPath, String contentPath) {
        super();
        this.user = user;
