 ...
 */
@AuditableClass
public class VerifyUserNEFTDetailsResponse extends ServiceResponse {
	...
	public VerifyUserNEFTDetailsResponse(
	...
	public VerifyUserNEFTDetailsResponse(boolean successful, String message) {
