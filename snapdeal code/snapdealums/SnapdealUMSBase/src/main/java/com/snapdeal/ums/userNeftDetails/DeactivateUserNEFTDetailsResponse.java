 ...
 */
@AuditableClass
public class DeactivateUserNEFTDetailsResponse extends ServiceResponse {
	...
	public DeactivateUserNEFTDetailsResponse(
	...
	public DeactivateUserNEFTDetailsResponse(boolean successful, String message) {
