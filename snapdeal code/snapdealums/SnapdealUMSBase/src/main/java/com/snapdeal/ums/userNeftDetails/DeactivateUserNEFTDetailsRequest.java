...
@AuditableClass
public class DeactivateUserNEFTDetailsRequest extends ServiceRequest
{
    ...
    public DeactivateUserNEFTDetailsRequest()
    {

        super();
    }

    public DeactivateUserNEFTDetailsRequest(int userNEFTDetails)
    {
